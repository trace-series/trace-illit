with open('/Users/missinglink/trace-illit/trace-illit.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
with open('/Users/missinglink/trace-illit/trace-illit.html', 'w', encoding='utf-8') as f:
    f.write(html)
